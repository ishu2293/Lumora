...
Lumora is a full-stack AI chatbot built with React, Node.js, Express, MongoDB Atlas, and Groq API. It provides a simple conversational interface with persistent chat history and thread management.
